...
window.showCopyMessage = /*#__PURE__*/function () {
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            if (!(document.getElementById(id + "-copied").hidden === true)) {
              _context.next = 5;
              break;
            }

            document.getElementById(id + "-copied").hidden = false; // сделать видимым

            _context.next = 4;
            return sleep();

          case 4:
            document.getElementById(id + "-copied").hidden = true; // сделать НЕ видимым
